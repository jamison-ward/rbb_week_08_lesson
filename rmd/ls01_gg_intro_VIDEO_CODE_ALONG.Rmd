...
source(here("autograder/ls01_gg_intro_autograder.R"))
```
...
nigerm04_scatter <- ggplot(data = nigerm04,
       mapping = aes(x = week, y = cases)) +
  geom_point()
...
```{r}
# Submit your answer:
nigerm04_bar <- ggplot(data = nigerm04,
       mapping = aes(x = week, y = cases)) +
  geom_col()
...
```{r}
# Submit your answer:
nigerm04_pinkbar <- ggplot(data = nigerm04,
       mapping = aes(x = week, y = cases)) +
  geom_col(fill = "hotpink")
